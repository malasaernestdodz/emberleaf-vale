...
- Name: props.spec.ts >> terrain fits the buildings >> grade hugs the walls so bases are neither buried nor floating
- Location: e2e\props.spec.ts:135:3
